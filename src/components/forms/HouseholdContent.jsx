...
const image = "https://res.cloudinary.com/dcqd4u6ux/image/upload/f_auto,q_auto/v1779560611/household_jfeeta.png";
const formlogo = "https://res.cloudinary.com/dcqd4u6ux/image/upload/f_auto,q_auto/v1779560601/formlogo_fpypyo.png";

const HouseholdContent = ({ onClose, userData }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 p-4 lg:mt-0 mt-6 text-gray-800">
            <div className="bg-white w-full mt-16 sm:w-[80%] md:w-[70%] lg:w-[60%] max-h-[90vh] rounded-[20px]-[20px]-lg shadow-lg flex overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-6 relative overflow-y-auto">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 text-black">Household Content Insurance Proposal Request</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 text-black">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full mt-1 p-3 border rounded-[5px] shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
                        <div>
                            <label htmlFor="fullname" className="block text-sm font-medium">
