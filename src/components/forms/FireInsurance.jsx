...
const image = "https://res.cloudinary.com/dcqd4u6ux/image/upload/f_auto,q_auto/v1779560534/fire_aukmm7.png";
            ...
            <div className="bg-white w-full mt-16 sm:w-[80%] md:w-[70%] lg:w-[60%] max-h-[90vh] rounded-[20px]-lg shadow-lg flex overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-6 relative overflow-y-auto">
                    ...
                    <form ref={formRef} onSubmit={sendEmail} className="space-y-8 text-black">
                        ...
                        <button
                            type="submit"
                            className="bg-[#b5996e] text-white px-6 py-3 rounded-[5px]"
                        >
                            Submit Proposal
                        </button>
                    </form>
