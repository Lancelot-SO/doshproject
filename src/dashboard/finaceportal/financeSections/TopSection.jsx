...
export default function TopSection() {
    ...
    return (
        <div className="">
            <div className="relative flex w-[845px] h-[244px] bg-black rounded-3xl border border-gray-800 p-4">
                {/* Header */}
                <div className='flex flex-col'>
                    <div className="space-y-1 mb-4">
                        <p className="text-gray-400">{formattedDate}</p>
                        <p className="text-gray-400">{formattedTime}</p>
                        <h1 className="text-[25px] font-bold text-white">Hello Jerry</h1>
                    </div>
                    ...
                    <div className="flex flex-row gap-4  pb-4">
                        ...
                        <div className='relative w-[200px] h-[110px]'>
                            ...
                            <div className='absolute right-[3px] top-[30%] flex flex-col gap-4'>
